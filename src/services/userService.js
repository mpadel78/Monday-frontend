...
export const getSingleUserTotalPoints = async (userId) => {
  return axios.get(`http://flask-env.eba-pqxgz2ka.us-east-2.elasticbeanstalk.com/getSingleUserTotalPoints/${userId}`, {headers: {
      'content-type': 'application/json'
    }}
...
export const getSingleUserTotalPointsPerMonthByWeek = async (userId) => {
  return axios.get(`http://flask-env.eba-pqxgz2ka.us-east-2.elasticbeanstalk.com/getSingleUserTotalPointsPerMonthByWeek/${userId}`, {headers: {
      'content-type': 'application/json'
    }}
  ).then(response =>  response.data);
};
...
export const getSingleUserTotalPointsPerYearByMonth = async (userId) => {
  return axios.get(`http://flask-env.eba-pqxgz2ka.us-east-2.elasticbeanstalk.com/getSingleUserTotalPointsPerYearByMonth/${userId}`, {headers: {
      'content-type': 'application/json'
    }}
  ).then(response =>  response.data);
};
...
export const getSingleUserTotalPointsPerWeekPerActivity = async (userId) => {
  return axios.get(`http://flask-env.eba-pqxgz2ka.us-east-2.elasticbeanstalk.com/getSingleUserTotalPointsPerWeekPerActivity/${userId}`, {headers: {
      'content-type': 'application/json'
    }}
  ).then(response =>  response.data);
};
...
export const getSingleUserTotalPointsYTDByActivity = async (userId) => {
    return axios.get(`http://flask-env.eba-pqxgz2ka.us-east-2.elasticbeanstalk.com/getSingleUserTotalPointsYTDByActivity/${userId}`, {headers: {
            'content-type': 'application/json'
        }}
